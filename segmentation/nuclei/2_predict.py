...
def predict_nuclei(path, ckpt, target, gpus, with_roi=False):
    input_path = os.path.join(ROOT, 'rawdata/sbem-6dpf-1-whole-raw.n5')
    input_key = 'setup0/timepoint0/s3'
    ...
    out_key = {'volumes/nuclei/foreground': (0, 1),
               'volumes/nuclei/affinities': (1, 13)}
...
if __name__ == '__main__':
    ...
    # ckpt = ''/g/kreshuk/data/arendt/platyneris_v1/trained_networks/nuclei_v8/Weights''
    # clean retrain
    ...
    predict_nuclei(args.path, args.ckpt, args.target, args.gpus, bool(args.with_roi))
